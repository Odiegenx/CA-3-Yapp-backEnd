...
| /getThreadById | Id of thread | Returns a specific thread |
| /editThread | Takes edited thread | Returns edited thread from database |
| /editPost | Takes edited post as body | Returns edited post from database |
